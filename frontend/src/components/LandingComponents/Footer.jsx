...
const Footer = () =>{
    ...
    <section className="py-8 bg-darkBlue">
    <div className="px-4 mx-20 md:mx-auto sm:px-20 lg:px-8 max-w-7xl">
        ...
        <hr className="my-6 border-gray-200 hidden md:block" />

        <p className="text-sm text-center text-white mt-4 md:mt-0">Disclaimer: This website is a personal project. Any mention of persons or companies is fictional and not associated with them.</p>
    </div>
</section>
    )
}
